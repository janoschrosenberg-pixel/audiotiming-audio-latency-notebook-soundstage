...
<!-- readme-locale:zh -->
<div align="center">
<img src="./public/logo.svg" alt="AudioTiming — Windows audio — Soundstage" width="64" height="64">
<h1>AudioTiming — Windows audio — Soundstage</h1>
</div>

独立的项目设计文档，适用对象： **Windows audio**。
...
- **设备格式清单** (Device format inventory) — 规划模块，尚未实现。
- **缓冲区实验日志** (Buffer experiment journal) — 规划模块，尚未实现。
- **音频中断观测日志** (Dropout observation log) — 规划模块，尚未实现。
